                ...
                >
                  ...
                  <div className="flex justify-between items-start mt-1 gap-3">
                    <div className="min-w-0">
                      ...
                      <h3 className="text-lg sm:text-xl font-bold text-foreground leading-tight group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors truncate" title={cls.title || ''}>{cls.title}</h3>
                    </div>
